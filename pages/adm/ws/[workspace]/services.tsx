import { WorkspaceServices } from "layouts/main/WorkspaceServices/WorkspaceServices"
...
type WorkspaceServicesPageProps = {
...
export default function WorkspaceServicesPage({
  ...
  return (
    <>
      ...
      <WorkspaceServices initialWorkspaceData={localWorkspaceData} />
    </>
  )
}
